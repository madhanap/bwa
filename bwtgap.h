...
extern "C" {
	...
	void bwt_match_gap1(bwt_t *const bwt, int len, const ubyte_t *seq, bwt_width_t *w, bwt_width_t *seed_w,
							  const gap_opt_t *opt, bwt_aln1_t **aln, int *_n_aln, int *_act_n_aln, gap_stack_t *stack);
